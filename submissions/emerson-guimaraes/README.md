...
Auditei os dados antes de analisar, e o **Dataset 1 é gerado por Faker**: 8 de 9 testes o condenam, incluindo 100% dos e-mails em domínios reservados da RFC 2606. Gargalos e drivers de satisfação, portanto, **não têm resposta verdadeira** nesses dados — e eu entrego o teste que prova, em vez de um número inventado. A terceira pergunta tem resposta e vale dinheiro: **R$ 90.000/ano em triagem manual** (projeção para os 30 mil tickets/ano do brief), dos quais **R$ 63.472 são recuperáveis** por um classificador treinado nos 47.837 tickets **reais** do Dataset 2 — 86,4% de acurácia e, a 0,80 de confiança, **roteia sozinho 60,11% dos tickets com 97,48% de acerto**, com payback em ~2,6 meses. A recomendação é implantar em fases, começando por uma fase de sombra a custo zero, e manter decisões de privilégio e de gasto sempre com humano.
