...
> **Duas categorias ficam sempre com humano — mesmo quando o modelo acerta com 100% de confiança.** O brief avisa que automatizar 100% é red flag, não virtude, e que os melhores candidatos sabem onde parar. Saber onde parar não sai de uma métrica: `Purchase` tem a segunda melhor precisão das oito classes (0,946) e está fora da automação, porque são decisões de gasto.

Construí um roteador de tickets que **decide sozinho 60,11% dos casos com 97,48% de acerto** e sabe quando não sabe — recuperando **R$ 63.472/ano** numa operação de 30 mil tickets, com payback em ~2,6 meses. O ganho é líquido: desconta o retrabalho dos próprios erros do modelo, e é por isso que a recomendação é o limiar 0,80 e não o mais alto possível — do cenário recomendado para o agressivo, a cobertura sobe 9,6 pontos e o ganho sobe R$ 1.774. Os números de tempo e satisfação do Dataset 1 não entram em nenhuma conta: auditei antes de usar e ele não passa (8 de 9 testes, 100% dos e-mails em domínios reservados da RFC 2606, todas as categóricas uniformes), então o peso quantitativo está nos 47.837 tickets **reais** do Dataset 2. As duas perguntas do diagnóstico que esses dados não respondem — gargalos e drivers de satisfação — vêm com o teste que prova, não com número inventado ([comparação lado a lado com o que uma IA responderia](solution/relatorio/01_diagnostico_operacional.md#por-que-isto-importa-mais-do-que-uma-resposta-inventada)).
